...
# ---------------------------------------------------------------------------
# 1. CONFIGURE YOUR PORTFOLIO HERE
# ---------------------------------------------------------------------------
PORTFOLIO = {
    "NVDA": 0.30,   # semiconductors / AI growth — overweighted conviction bet
    "JPM":  0.20,   # financials
    "JNJ":  0.20,   # healthcare
    "KO":   0.15,   # consumer staples
    "CROX": 0.15,   # mid-cap consumer growth
}
